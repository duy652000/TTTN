        ...
        <div class="container">
            <div class="page-title-area">
                <div class="item md-order-1">
                    <a href="movie-details" class="custom-button back-button">
                        <i class="flaticon-double-right-arrows-angles"></i>trở lại
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="proceed-book bg_img" data-background="./assets/images/movie/movie-bg-proceed.jpg">
                <div class="proceed-to-book">
                    ...
                    <div class="book-item">
                        <a href="movie-checkout" class="custom-button">tiếp tục</a>
                    </div>
                </div>
            </div>
        </div>
